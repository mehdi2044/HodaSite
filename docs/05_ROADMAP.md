...
به‌روزرسانی ۲۰۲۶-۰۹-۱۴: توسعه و آزمون خودکار فاز ۶ در PR #34 تکمیل و ادغام شد. فاز ۷ در PR #35 پیاده‌سازی شده و در بررسی نهایی است؛ برنامه و معیارهای آن در `PHASE07_IMPLEMENTATION_PLAN.md` ثبت شده‌اند. آزمون اتصال با کلید محلی و پذیرش گوشی واقعی همچنان جداگانه باقی است. مرحلهٔ بعدی توسعه، پس از بسته‌شدن فاز ۷، بخش‌های داخلی فاز ۸ است؛ انتشار خودکار جزو آن نیست.
