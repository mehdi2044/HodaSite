...
## ترتیب اجرایی به‌روز — D54
۰۵ تکمیل عملیات و کنترل‌ها → **۰۵b طراحی موبایل و PWA** → ۰۶ مالی → ۰۷ ورود اطلاعات AI → ۰۸ SEO و کیفیت نهایی انتشار. معیارهای نصب پایه از ۰۸ به ۰۵b منتقل شده‌اند؛ شماره‌های فازهای بعدی تغییر نمی‌کنند. آغاز ۰۶ پس از تکمیل پیش‌نیازهاست، نه صرفاً ثبت برنامه.
