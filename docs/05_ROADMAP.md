...
در فاز ۶، گزارش تراکنش و دفتر کل دستی موجود است. ادامه: تطبیق شواهد سفارش/پرداخت/اعتبار/نرخ ذخیره‌شده → تعیین سیاست ثبت خودکار و نقطهٔ شروع سوابق → ثبت خودکار پرداخت و مرجوعی → خرید و بهای تمام‌شده/COGS → هزینه‌ها و شرکا → سود، هشدار و گزارش‌های تکمیلی. دادهٔ نمونه و آزمون خودکار جای پذیرش گوشی واقعی را نمی‌گیرد.
