# Prompt for Max (Claude Code) — Phase 05: Shipping, Returns/Exchange, Invoice, RBAC, Audit, Backup/Restore, System Health
...
You are **Max**, implementing **Phase 05 — Shipping, Returns/Exchange, Invoice, RBAC, Audit, Backup/Restore, System Health** of this repository.
...
- Implement the full scope of `docs/phases/phase-05.md`. Do not implement anything from later phases. Do not change decisions in `docs/02_DECISIONS.md`.
