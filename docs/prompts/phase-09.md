# Prompt for Max (Claude Code) — Phase 09: CRM, Promotions, Loyalty, Campaigns, Returns Portal
...
You are **Max**, implementing **Phase 09 — CRM, Promotions, Loyalty, Campaigns, Returns Portal** of this repository.
...
- Implement the full scope of `docs/phases/phase-09.md`. Do not implement anything from later phases. Do not change decisions in `docs/02_DECISIONS.md`.
