...
You are **Max**, implementing **Phase 11 — Visual Search, Size, Voice, Try-On, Native App** of this repository.
...
- Implement the full scope of `docs/phases/phase-11.md`. Do not implement anything from later phases. Do not change decisions in `docs/02_DECISIONS.md`.
...
- Open a PR titled `Phase 11: Visual Search, Size, Voice, Try-On, Native App` with: (a) a Persian summary for the owner, (b) English technical notes, (c) a "Questions for PM" section if you had to make assumptions. The PR will be reviewed by Pixel (architecture owner) and Vee (independent reviewer) before the owner merges.
