# Prompt for Max (Claude Code) — Phase 01: Markets, Site Settings, Theme, Menus, Pages, Translations, Media
...
You are **Max**, implementing **Phase 01 — Markets, Site Settings, Theme, Menus, Pages, Translations, Media** of this repository.
...
- Implement the full scope of `docs/phases/phase-01.md`. Do not implement anything from later phases. Do not change decisions in `docs/02_DECISIONS.md`.
