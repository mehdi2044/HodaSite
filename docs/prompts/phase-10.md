# Prompt for the implementation agent — Phase 10: AI Shopping Agent, Semantic Search, Recommendations
...
You are **the implementation agent**, implementing **Phase 10 — AI Shopping Agent, Semantic Search, Recommendations** of this repository.
...
- Implement the full scope of `docs/phases/phase-10.md`. Do not implement anything from later phases. Follow current decisions in `docs/02_DECISIONS.md`; record any necessary delegated technical decision before implementation under D50/D63, without changing product scope by assumption.
