# Prompt for Max (Codex) — Phase 06: Finance Core
...
3. Read `docs/phases/phase-06.md` — this is your exact scope and acceptance criteria.
4. Use `docs/spec/MASTER_SPEC_v1.md` only as background for business intent.
5. Phase 05 is merged. Read `docs/PROGRESS.md` for its report and known limitations. Do not refactor Phase 05 beyond what this phase needs.
