# Prompt for Max (Claude Code) — Phase 08: SEO, PWA, Performance, Launch Checklist
...
You are **Max**, implementing **Phase 08 — SEO, PWA, Performance, Launch Checklist** of this repository.
...
3. Read `docs/phases/phase-08.md` — this is your exact scope and acceptance criteria.
4. Use `docs/spec/MASTER_SPEC_v1.md` only as background for business intent.
5. Phase 07 is merged. Read `docs/PROGRESS.md` for its report and known limitations. Do not refactor Phase 07 beyond what this phase needs.

Then:
- Create branch `phase/08`.
- Implement the full scope of `docs/phases/phase-08.md`. Do not implement anything from later phases. Do not change decisions in `docs/02_DECISIONS.md`.
...
- Update `docs/PROGRESS.md`: mark Phase 08 done, list what was built, exact manual test steps in **simple Persian** for a non-programmer, and known limitations.
...
- Open a PR titled `Phase 08: SEO, PWA, Performance, Launch Checklist` with: (a) a Persian summary for the owner, (b) English technical notes, (c) a "Questions for PM" section if you had to make assumptions. The PR will be reviewed by Pixel (architecture owner) and Vee (independent reviewer) before the owner merges.
