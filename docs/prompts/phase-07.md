# Prompt for the implementation agent — Phase 07: AI Gateway & Data Entry Assistant
...
You are **the implementation agent**, implementing **Phase 07 — AI Gateway & Data Entry Assistant** of this repository.
...
- Implement the full scope of `docs/phases/phase-07.md`. Do not implement anything from later phases. Follow current decisions in `docs/02_DECISIONS.md`; record any necessary delegated technical decision before implementation under D50/D63, without changing product scope by assumption.
