...
- تأیید محلی: Prisma generate، lint، TypeScript، ۱۳۴ تست واحد و build تولیدی موفق. ۴۲ تست دیتابیس به‌علت نبود TEST_DATABASE_URL محلی اجرا نشدند. Docker، مرورگر و PostgreSQL واقعی باید در CI تأیید شوند.
