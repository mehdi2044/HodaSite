...
- درگ‌اند‌دراپ/مودال انتخاب رسانه روی `next dev` محلی به‌صورت تعاملی در مرورگر تست نشده (نبود ابزار مرورگر در این نشست)؛ فقط از طریق منطق سرور/API و ساختار HTML تأیید شده.
