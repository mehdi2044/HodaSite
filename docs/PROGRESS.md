...
- Phase 06 first usable slice: `/admin/finance` shows paid-order totals, approved external/credit payments, completed external/credit refunds, net external movement and daily breakdowns. Market and inclusive UTC date filters (maximum 366 days), exact four-decimal amounts, fa/tr/en, mobile cards and private CSV use the same report service. No currency conversion or cross-currency total is invented.
