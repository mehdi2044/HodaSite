...
- آزمون محلی: lint، TypeScript، build تولیدی و ۲۲۹ تست واحد موفق؛ ۵۱ تست integration به‌علت نبود PostgreSQL محلی اجرا نشده‌اند و CI مرجع آن‌هاست. پوشش خطی: Money برابر ۱۰۰٪، FX برابر ۱۰۰٪، سرویس قیمت ۹۹٫۶۵٪، موتور هزینه ۹۷٫۹۵٪، quote سبد ۹۵٫۴٪ و انبار ۹۹٫۷٪. حداقل ۹۰٪ برای هر فایل حساس در test:coverage و CI اجباری شد.
